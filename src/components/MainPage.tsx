              ...
              return (
                <Link to={`/${id}`} key={index}>
                  <div  className="card">
                    ...
                    {/* {hover && <span className='three-dots'>
          ...
          : apiData.map((currEle, index) => {
              ...
              return (
                <div onClick = {()=>clickOnCardHandler(id)} key={index}>
                  <div  className="card"  onMouseEnter={()=>onMouseEnter(index)} onMouseLeave={()=>onMouseLeaver(index)}>
                  {/* <div  className="card"  onMouseEnter={()=>setIsHovered(true)} onMouseLeave={()=>setIsHovered(false)}> */}
                    ...
                    {hover && <span className='three-dots' onClick={clickedOnSpan} >
                    <i className="fa-solid fa-ellipsis-vertical"></i>
                    {showModal && <Modal/>}
                    </span>
                    }
